...
<head>
    ...
    <title>Physical Activity Survey Question 9</title>
...
<section class="page-section" id="quest">
    <div class="container">
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">
            <p>Question 9.</p><br>On a typical day, how many of your meals or snacks contain fruit?</h2>
        <form id="health-form" action="question10.php" method="post" onsubmit="return validateActivity()">
            ...
            <input type="hidden" name="lastPageID" value="question9">
            <input type="submit" value="OK" class="btn btn-primary">
            <a href="question8.php" class="btn btn-secondary">Back</a>
